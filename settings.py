...
DATA_SOURCE_BUDGET      = 'http://www.lavallduixo.es/es/page/presupuestos'

# Setup Data Source Population link
DATA_SOURCE_POPULATION  = 'http://www.ine.es/jaxiT3/Tabla.htm?t=2865'

# Setup Data Source Inflation link
DATA_SOURCE_INFLATION   = 'http://www.ine.es/jaxiT3/Tabla.htm?t=10019&L=0'

# Setup Main Entity Web Url
MAIN_ENTITY_WEB_URL     = 'http://www.lavallduixo.es/'

# Setup Main Entity Legal Url (if empty we hide the link)
MAIN_ENTITY_LEGAL_URL   = 'http://www.lavallduixo.es/es/content/aviso-legal'

# Setup Main Entity Legal Url (if empty we hide the link)
MAIN_ENTITY_PRIVACY_URL = 'http://www.lavallduixo.es/es/page/politica-privacidad'
...
FEATURED_PROGRAMMES = ['1710', '1521', '1650', '1330', '1630', '1621', '4320', '2335']
